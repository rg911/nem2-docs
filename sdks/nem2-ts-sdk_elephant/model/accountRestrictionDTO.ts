...
import { AnyOfstringTransactionTypeEnumstring } from './anyOfstringTransactionTypeEnumstring';
...
export class AccountRestrictionDTO {
    ...
    */
    'values': Array<AnyOfstringTransactionTypeEnumstring>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "values",
            "baseName": "values",
            "type": "Array<AnyOfstringTransactionTypeEnumstring>"
        }    ];
