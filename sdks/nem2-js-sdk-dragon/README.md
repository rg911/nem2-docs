...
*CatapultRestApiReference.AccountRoutesApi* | [**getAccountProperties**](docs/AccountRoutesApi.md#getAccountProperties) | **GET** /account/{accountId}/properties/ | Get account configurable properties information
...
*CatapultRestApiReference.AccountRoutesApi* | [**getAccountsNames**](docs/AccountRoutesApi.md#getAccountsNames) | **POST** /account/names | Get readable names for a set of accountIds.
...
*CatapultRestApiReference.BlockRoutesApi* | [**getBlockByHeight**](docs/BlockRoutesApi.md#getBlockByHeight) | **GET** /block/{height} | Get block information
*CatapultRestApiReference.BlockRoutesApi* | [**getBlockReceipts**](docs/BlockRoutesApi.md#getBlockReceipts) | **GET** /block/{height}/receipts | Get receipts from a block
*CatapultRestApiReference.BlockRoutesApi* | [**getBlockTransactions**](docs/BlockRoutesApi.md#getBlockTransactions) | **GET** /block/{height}/transactions | Get transactions from a block
*CatapultRestApiReference.BlockRoutesApi* | [**getBlocksByHeightWithLimit**](docs/BlockRoutesApi.md#getBlocksByHeightWithLimit) | **GET** /blocks/{height}/limit/{limit} | Get blocks information
*CatapultRestApiReference.BlockRoutesApi* | [**getMerkleReceipts**](docs/BlockRoutesApi.md#getMerkleReceipts) | **GET** /block/{height}/receipt/{hash}/merkle | Get the merkle path for a given a receipt statement hash and block
*CatapultRestApiReference.BlockRoutesApi* | [**getMerkleTransaction**](docs/BlockRoutesApi.md#getMerkleTransaction) | **GET** /block/{height}/transaction/{hash}/merkle | Get the merkle path for a given a transaction and block
*CatapultRestApiReference.ChainRoutesApi* | [**getBlockchainHeight**](docs/ChainRoutesApi.md#getBlockchainHeight) | **GET** /chain/height | Get the current height of the chain
*CatapultRestApiReference.ChainRoutesApi* | [**getBlockchainScore**](docs/ChainRoutesApi.md#getBlockchainScore) | **GET** /chain/score | Get the current score of the chain
*CatapultRestApiReference.DiagnosticRoutesApi* | [**getDiagnosticStorage**](docs/DiagnosticRoutesApi.md#getDiagnosticStorage) | **GET** /diagnostic/storage | Get the storage information of the node
*CatapultRestApiReference.DiagnosticRoutesApi* | [**getServerInfo**](docs/DiagnosticRoutesApi.md#getServerInfo) | **GET** /diagnostic/server | Get the version of the running rest component
...
*CatapultRestApiReference.MosaicRoutesApi* | [**getMosaicsNames**](docs/MosaicRoutesApi.md#getMosaicsNames) | **POST** /mosaic/names | Get readable names for a set of mosaics
...
## Documentation for Models
 ...
 - [CatapultRestApiReference.AccountNamesDTO](docs/AccountNamesDTO.md)
 ...
 - [CatapultRestApiReference.AccountPropertyTypeEnum](docs/AccountPropertyTypeEnum.md)
 - [CatapultRestApiReference.AccountsIds](docs/AccountsIds.md)
 - [CatapultRestApiReference.AliasDTO](docs/AliasDTO.md)
 - [CatapultRestApiReference.AliasTypeEnum](docs/AliasTypeEnum.md)
 ...
 - [CatapultRestApiReference.HeightInfoDTO](docs/HeightInfoDTO.md)
 ...
 - [CatapultRestApiReference.MosaicNamesDTO](docs/MosaicNamesDTO.md)
 - [CatapultRestApiReference.MosaicPropertyDTO](docs/MosaicPropertyDTO.md)
 - [CatapultRestApiReference.MosaicPropertyIdEnum](docs/MosaicPropertyIdEnum.md)
 ...
 - [CatapultRestApiReference.MultisigModificationTypeEnum](docs/MultisigModificationTypeEnum.md)
 ...
 - [CatapultRestApiReference.NamespaceTypeEnum](docs/NamespaceTypeEnum.md)
 - [CatapultRestApiReference.NetworkTypeDTO](docs/NetworkTypeDTO.md)
 - [CatapultRestApiReference.NetworkTypeEnum](docs/NetworkTypeEnum.md)
 - [CatapultRestApiReference.NodeInfoDTO](docs/NodeInfoDTO.md)
 - [CatapultRestApiReference.NodeTimeDTO](docs/NodeTimeDTO.md)
 - [CatapultRestApiReference.ReceiptTypeEnum](docs/ReceiptTypeEnum.md)
 - [CatapultRestApiReference.ResolutionEntryDTO](docs/ResolutionEntryDTO.md)
 - [CatapultRestApiReference.ResolutionStatementDTO](docs/ResolutionStatementDTO.md)
 - [CatapultRestApiReference.RolesTypeEnum](docs/RolesTypeEnum.md)
 - [CatapultRestApiReference.ServerDTO](docs/ServerDTO.md)
 - [CatapultRestApiReference.ServerInfoDTO](docs/ServerInfoDTO.md)
 - [CatapultRestApiReference.SourceDTO](docs/SourceDTO.md)
 - [CatapultRestApiReference.StatementsDTO](docs/StatementsDTO.md)
 - [CatapultRestApiReference.StorageInfoDTO](docs/StorageInfoDTO.md)
 ...
 - [CatapultRestApiReference.TransactionInfoDTO](docs/TransactionInfoDTO.md)
 - [CatapultRestApiReference.TransactionMetaDTO](docs/TransactionMetaDTO.md)
 - [CatapultRestApiReference.TransactionPayload](docs/TransactionPayload.md)
 - [CatapultRestApiReference.TransactionStatementDTO](docs/TransactionStatementDTO.md)
